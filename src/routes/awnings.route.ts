...
app.get("/getAwnings", userMiddleware, getAwningsDesc, async (c: Context) => {
...
app.get("/getAwning/:id", userMiddleware, getAwningDesc, async (c: Context) => {
  const supabase = c.get("supabase");
...
app.post("/postAwning", userMiddleware, postAwningDesc, async (c: Context) => {
  const supabase = c.get("supabase");
...
app.put("/putAwning", userMiddleware, putAwningDesc, async (c: Context) => {
  const supabase = c.get("supabase");
